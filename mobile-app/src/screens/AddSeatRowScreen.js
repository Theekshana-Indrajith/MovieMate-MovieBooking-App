...
import { ArrowLeft, Save, Armchair } from 'lucide-react-native';
        ...
        try {
            ...
            if (res.data.success) {
                if (Platform.OS === 'web') {
                    ...
                    Alert.alert('Success', 'Row added successfully!', [
            ...
            if (Platform.OS === 'web') {
                window.alert(err.response?.data?.error || 'Failed to add row');
            } else {
    ...
    return (
        <SafeAreaView style={styles.container}>
            <View style={styles.header}>
                ...
                <Text style={styles.headerTitle}>Add Seat Row</Text>
                <View style={{ width: 44 }} />
            </View>
            ...
            <ScrollView contentContainerStyle={styles.content}>
                ...
                <TextInput style={styles.input} value={rowCode} onChangeText={setRowCode} placeholder="A1" placeholderTextColor="#64748B" />
                ...
                <View style={{ flexDirection: 'row', gap: 10 }}>
                    <View style={{ flex: 1 }}>
                        ...
                        <TextInput style={styles.input} value={seatsCount} onChangeText={setSeatsCount} keyboardType="numeric" placeholder="6" placeholderTextColor="#64748B" />
                    </View>
                    <View style={{ flex: 1 }}>
                        <Text style={styles.label}>Additional Price (Rs.)</Text>
                        <TextInput style={styles.input} value={extraPrice} onChangeText={setExtraPrice} keyboardType="numeric" placeholder="0" placeholderTextColor="#64748B" />
                    </View>
                </View>

                <TouchableOpacity style={styles.saveButton} onPress={handleSave} disabled={loading}>
                    {loading ? <ActivityIndicator color="#fff" /> : <><Save color="#fff" size={20} /><Text style={styles.saveBtnText}>Save Row</Text></>}
                </TouchableOpacity>
            </ScrollView>
        </SafeAreaView>
    );
...
const styles = StyleSheet.create({
    ...
    saveButton: { flexDirection: 'row', backgroundColor: '#10B981', padding: 18, borderRadius: 16, justifyContent: 'center', alignItems: 'center', marginTop: 10 },
