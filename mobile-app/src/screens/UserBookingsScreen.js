        ...
        return (
            <View style={styles.ticketCard}>
                <View style={styles.ticketTop}>
                    {poster ? (
                        <Image source={{ uri: `http://192.168.8.106:5000/uploads/movies/${poster}` }} style={styles.poster} resizeMode="cover" />
                    ) : (
                    ...
                    <View style={styles.movieDetails}>
                        ...
                        <View style={[styles.statusBadge, !isConfirmed && { backgroundColor: 'rgba(239, 68, 68, 0.15)' }]}>
                            <Text style={[styles.statusText, !isConfirmed && { color: '#EF4444' }]}>{item.status}</Text>
                        </View>
                        
                        <View style={styles.infoRow}>
                            <CalIcon color="#94A3B8" size={12} />
                            <Text style={styles.infoText}>{dateObj.toDateString()}</Text>
                            {item.time && (
                                <>
