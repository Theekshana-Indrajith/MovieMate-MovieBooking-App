...
const styles = StyleSheet.create({
    ...
    addButton: { flexDirection: 'row', alignItems: 'center', padding: 10, backgroundColor: '#10B981', borderRadius: 12 },
    listContent: { padding: 20 },
    card: { backgroundColor: '#1E293B', borderRadius: 20, marginBottom: 16, flexDirection: 'row', padding: 12, borderWidth: 1, borderColor: '#334155' },
    ...
    editBtn: { flexDirection: 'row', alignItems: 'center', backgroundColor: 'rgba(59, 130, 246, 0.1)', paddingHorizontal: 12, paddingVertical: 6, borderRadius: 8, marginRight: 10 },
    editBtnText: { color: '#3B82F6', fontSize: 12, fontWeight: 'bold', marginLeft: 6 },
    deleteBtn: { padding: 6, backgroundColor: 'rgba(239, 68, 68, 0.1)', borderRadius: 8 },
    skeletonCard: { flexDirection: 'row', backgroundColor: '#1E293B', padding: 12, borderRadius: 20, marginBottom: 16, borderWidth: 1, borderColor: '#334155' },
